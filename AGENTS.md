...
唯一保留的 E2E 基线任务是 **`20260812-163504-32b726a1`**（2026-08-12）。
...
- 当想理解各 Agent 上下文如何流转、或排查论文里出现「按要求不用某方法」这类过程回声时，参考 [`docs/enhance/runtime-context.md`](docs/enhance/runtime-context.md)
